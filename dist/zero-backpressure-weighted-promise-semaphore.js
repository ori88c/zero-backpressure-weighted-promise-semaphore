...
exports.ZeroBackpressureWeightedSemaphore = void 0;
 ...
 */
class ZeroBackpressureWeightedSemaphore {
    /**
     ...
     */
    constructor(totalAllowedWeight, estimatedMaxNumberOfConcurrentJobs = DEFAULT_NUMBERS_OF_SLOTS) {
        this._amountOfCurrentlyExecutingJobs = 0;
        ...
        this._availableSlotsStack = new Array(initialNumberOfSlots).fill(0);
     ...
     */
    async waitForCompletion(job, weight) {
     ...
     */
    async _handleJobExecution(job, allottedSlot, weight, isBackgroundJob) {
        try {
...
exports.ZeroBackpressureWeightedSemaphore = ZeroBackpressureWeightedSemaphore;
function isNaturalNumber(num) {
    const floored = Math.floor(num);
    return floored >= 1 && floored === num;
}
//# sourceMappingURL=zero-backpressure-weighted-promise-semaphore.js.map